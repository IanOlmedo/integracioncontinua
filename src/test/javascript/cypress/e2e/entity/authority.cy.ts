...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'f222fead-bba7-4137-a3b8-533df11e2344' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('d4dbc32c-1f76-4714-8ffb-f992e94adad3');
      cy.get(`[data-cy="name"]`).should('have.value', 'd4dbc32c-1f76-4714-8ffb-f992e94adad3');
